public class LinkedList {
    ...
    public static void main(String[] args) {
        ...
        // Creating a cycle: last node points to the node with value 3
        head.next.next.next.next.next = head.next.next;

        // Test cycle detection and removal
        System.out.println("Cycle exists: " + isCycle()); // Expected output: true
        removeCycle();
        System.out.println("Cycle exists: " + isCycle()); // Expected output: false
